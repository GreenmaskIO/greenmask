...
func NewLargeObjectDumper(blobs *dump_objects.Blobs) *BlobsDumper {
	return &BlobsDumper{
		Blobs: blobs,
	}
}

func (lod *BlobsDumper) Execute(ctx context.Context, tx pgx.Tx, st storages.Storager) (dump_objects.Entry, error) {
