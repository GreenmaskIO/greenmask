...
var _ interfaces.DumpContextValidator = (*DumpContextValidator)(nil)
...
func (s *DumpContextValidator) Validate(ctx context.Context, input models.DumpContextValidatorInput) error {
	return nil
}
