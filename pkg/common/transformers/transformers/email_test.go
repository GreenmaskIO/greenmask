...
func TestNewEmailTransformer(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		localPartTemplateParameter := mocks2.NewParametrizerMock()
		domainPartTemplateParameter := mocks2.NewParametrizerMock()
		domainsParameter := mocks2.NewParametrizerMock()
		keepOriginalDomainParameter := mocks2.NewParametrizerMock()
		maxRandomLengthParameter := mocks2.NewParametrizerMock()
		keepNullParameter := mocks2.NewParametrizerMock()
		engineParameter := mocks2.NewParametrizerMock()
