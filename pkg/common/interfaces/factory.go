...
type ObjectDumpFactory = DumpFactory[commonmodels.ObjectKind, commonmodels.ObjectDumpSpec, ObjectDumper]
type SchemaDumpFactory = DumpFactory[commonmodels.SchemaDumpKind, commonmodels.SchemaDumpSpec, SchemaDumper]
