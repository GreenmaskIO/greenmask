	...
	tests := []struct {
	...
	}{
		{
			...
			staticParameters: map[string]commonmodels.ParamsValue{
				...
				"min_length": commonmodels.ParamsValue("10"),
				"max_length": commonmodels.ParamsValue("10"),
		...
		},
		{
			...
			staticParameters: map[string]commonmodels.ParamsValue{
				"column":     commonmodels.ParamsValue("data"),
				"min_length": commonmodels.ParamsValue("2"),
				"max_length": commonmodels.ParamsValue("30"),
				"engine":     commonmodels.ParamsValue("random"),
			},
			validateFn: func(t *testing.T, recorder commonininterfaces.Recorder) {
				val, err := recorder.GetRawColumnValueByName("data")
		...
		},
		{
			...
			staticParameters: map[string]commonmodels.ParamsValue{
				...
				"min_length": commonmodels.ParamsValue("10"),
				"max_length": commonmodels.ParamsValue("10"),
				"symbols":    commonmodels.ParamsValue("1234567890"),
				"engine":     commonmodels.ParamsValue("random"),
			},
			validateFn: func(t *testing.T, recorder commonininterfaces.Recorder) {
				val, err := recorder.GetRawColumnValueByName("data")
