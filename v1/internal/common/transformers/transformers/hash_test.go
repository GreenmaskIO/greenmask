...
//	tests := []struct {
//		name     string
//		staticParameters   map[string]toolkit.ParamsValue
//		original string
//		result   string
//	}{
//		{
...
//			driver, record := getDriverAndRecord(string(tt.staticParameters["column"]), tt.original)
//			transformer, warnings, err := HashTransformerDefinition.Instance(
//				context.Background(),
//				driver, tt.staticParameters,
//				nil,
//				"",
//			)
...
//			require.NoError(t, err)
//
//			res, err := r.GetRawColumnValueByName(string(tt.staticParameters["column"]))
//			require.NoError(t, err)
//
...
//	driver, record := getDriverAndRecord(string(staticParameters["column"]), original)
//	transformer, warnings, err := HashTransformerDefinition.Instance(
//		context.Background(),
//		driver, staticParameters,
//		nil,
//		"",
//	)
//	require.NoError(t, err)
...
//	require.NoError(t, err)
//
//	res, err := r.GetRawColumnValueByName(string(staticParameters["column"]))
//	require.NoError(t, err)
//
//	require.False(t, res.IsNull)
