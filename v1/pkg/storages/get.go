...
import (
	...
	directory2 "github.com/greenmaskio/greenmask/v1/pkg/storages/directory"
	s4 "github.com/greenmaskio/greenmask/v1/pkg/storages/s3"
)
...
func Get(
	...
	case s3StorageType:
		return s4.New(ctx, s3Cfg, logLevel)
	}
