...
import (
	...
	"github.com/greenmaskio/greenmask/v1/pkg/common/dump/processor"
	...
	"github.com/greenmaskio/greenmask/v1/pkg/mysql/dump/introspect"
	schemadump "github.com/greenmaskio/greenmask/v1/pkg/mysql/dump/schema"
	"github.com/greenmaskio/greenmask/v1/pkg/mysql/dump/taskproducer"
	"github.com/greenmaskio/greenmask/v1/pkg/mysql/metadata"
	mysqlmodels "github.com/greenmaskio/greenmask/v1/pkg/mysql/models"
	"github.com/greenmaskio/greenmask/v1/pkg/storages"
...
func (d *Dump) Run(ctx context.Context) (err error) {
	...
	hbw := heartbeat2.NewWorker(heartbeat2.NewWriter(d.st))
	...
	defer func() {
		...
		status := heartbeat2.StatusDone
		if err != nil {
			// if there is an error, we mark it as failed.
			status = heartbeat2.StatusFailed
		}
