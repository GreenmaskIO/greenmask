...
import (
	...
	context2 "github.com/greenmaskio/greenmask/v1/pkg/common/dump/context"
	"github.com/greenmaskio/greenmask/v1/pkg/common/dump/dumpers"
	"github.com/greenmaskio/greenmask/v1/pkg/common/interfaces"
	"github.com/greenmaskio/greenmask/v1/pkg/common/models"
	"github.com/greenmaskio/greenmask/v1/pkg/common/pipeline"
	"github.com/greenmaskio/greenmask/v1/pkg/common/rawrecord"
	"github.com/greenmaskio/greenmask/v1/pkg/common/record"
	subset2 "github.com/greenmaskio/greenmask/v1/pkg/common/subset"
	"github.com/greenmaskio/greenmask/v1/pkg/common/tabledriver"
	"github.com/greenmaskio/greenmask/v1/pkg/common/transformers/registry"
	"github.com/greenmaskio/greenmask/v1/pkg/mysql/dbmsdriver"
	streamers2 "github.com/greenmaskio/greenmask/v1/pkg/mysql/dump/streamers"
	mysqlmodels "github.com/greenmaskio/greenmask/v1/pkg/mysql/models"
...
func New(
	...
	s, err := subset2.NewSubset(tables, subset2.DialectMySQL)
	if err != nil {
...
func (tp *TaskProducer) getTableContext(ctx context.Context) ([]context2.TableContext, error) {
...
func (tp *TaskProducer) initTableDumper(
	tableContext context2.TableContext, objectID models.TaskID,
) (interfaces.Dumper, error) {
	tr := streamers2.NewTableDataReader(tableContext.Table, tp.connConfig, tableContext.Query)
	tw := streamers2.NewTableDataWriter(*tableContext.Table, tp.st, streamers2.CompressionSettings{
