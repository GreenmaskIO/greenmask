...
func (i *Introspector) GetTables() []models.Table {
	return i.tables
}

func (i *Introspector) GetCommonTables() []models2.Table {
	tables := make([]models2.Table, len(i.tables))
...
func (i *Introspector) getTables(ctx context.Context, tx *sql.Tx) ([]models.Table, error) {
...
func getTypeOID(columnType string, dataType *string) (models2.VirtualOID, error) {
...
func getTypeClass(
	...
	defaultTypeClass := models2.TypeClassUnsupported
	...
	if !ok {
		...
		return models2.TypeClassUnsupported
	}
	return typeClass
}

// getColumns - get all columns for a given table
func (i *Introspector) getColumns(ctx context.Context, tx *sql.Tx, tableSchema string, tableName string) ([]models.Column, error) {
	query := `
	...
	for rows.Next() {
		...
		columns = append(columns, models.NewColumn(
...
func (i *Introspector) getForeignKeyConstraints(
	...
	var constraints []models2.Reference
	for rows.Next() {
		var (
