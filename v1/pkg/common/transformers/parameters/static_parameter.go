...
import (
	...
	gmtemplate "github.com/greenmaskio/greenmask/v1/pkg/common/transformers/template"
...
func (sp *StaticParameter) executeTemplate(ctx context.Context) error {
	...
	if err != nil {
		vc.Add(models2.NewValidationWarning().
...
func validateColumnTypeIsSupported(ctx context.Context, properties *ColumnProperties, c *models2.Column) error {
	if properties == nil {
		return nil
	}
...
func (sp *StaticParameter) validateColumnContainer(ctx context.Context, rawValue models2.ParamsValue) error {
	...
	foundColumns := make([]models2.Column, 0, len(cc))
	for i, container := range cc {
		column, err := sp.driver.GetColumnByName(container.ColumnName())
		if err != nil {
			if errors.Is(err, models2.ErrUnknownColumnName) {
...
func (sp *StaticParameter) validateValue(ctx context.Context, rawValue models2.ParamsValue) error {
	...
	if sp.definition.AllowedValues != nil {
		if !slices.ContainsFunc(sp.definition.AllowedValues, func(allowedItem models2.ParamsValue) bool {
...
func (sp *StaticParameter) RawValue() (models2.ParamsValue, error) {
...
func parameterValuesToString(values []models2.ParamsValue) []string {
	var res []string
