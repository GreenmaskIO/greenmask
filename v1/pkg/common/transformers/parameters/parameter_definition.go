...
type Unmarshaler func(parameter *ParameterDefinition, driver commonininterfaces.DBMSDriver, src models2.ParamsValue) (any, error)
type DatabaseTypeUnmarshaler func(driver commonininterfaces.DBMSDriver, typeName string, v models2.ParamsValue) (any, error)
type RawValueValidator func(ctx context.Context, p *ParameterDefinition, v models2.ParamsValue) error

type ColumnContainerUnmarshaler func(ctx context.Context, parameter *ParameterDefinition, data models2.ParamsValue) ([]ColumnContainer, error)

const WithoutMaxLength = -1

func DefaultDatabaseTypeUnmarshaler(driver commonininterfaces.DBMSDriver, typeName string, v models2.ParamsValue) (any, error) {
...
type ColumnProperties struct {
	...
	// of the types is valid.
	AllowedTypeClasses []models2.TypeClass `mapstructure:"allowed_type_classes" json:"allowed_type_classes,omitempty"`
	...
	// of the types is valid.
	DeniedTypeClasses []models2.TypeClass `mapstructure:"denied_type_classes" json:"denied_type_classes,omitempty"`
...
func (cp *ColumnProperties) SetAllowedColumnTypeClasses(v ...models2.TypeClass) *ColumnProperties {
...
func (cp *ColumnProperties) SetDeniedColumnTypeClasses(v ...models2.TypeClass) *ColumnProperties {
...
func (cp *ColumnProperties) IsColumnTypeClassAllowed(v models2.TypeClass) bool {
...
func (cp *ColumnProperties) IsColumnTypeClassDenied(v models2.TypeClass) bool {
...
type ParameterDefinition struct {
	...
	DefaultValue models2.ParamsValue `mapstructure:"default_value" json:"default_value,omitempty"`
	...
	AllowedValues []models2.ParamsValue `mapstructure:"allowed_values" json:"allowed_values,omitempty"`
...
func (p *ParameterDefinition) SetAllowedValues(v ...models2.ParamsValue) *ParameterDefinition {
	p.AllowedValues = v
	return p
}
...
func (p *ParameterDefinition) SetDefaultValue(v models2.ParamsValue) *ParameterDefinition {
	p.DefaultValue = v
	return p
}
