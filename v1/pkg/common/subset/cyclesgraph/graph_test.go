...
import (
	...
	tablegraph2 "github.com/greenmaskio/greenmask/v1/pkg/common/subset/tablegraph"
...
func Test_NewGraph(t *testing.T) {
	...
	edge1 := tablegraph2.NewEdge(
		10,
		false,
		tablegraph2.NewTableLink(0, table1, nil, nil),
		tablegraph2.NewTableLink(1, table2, nil, nil),
	)

	edge2 := tablegraph2.NewEdge(
		11,
		false,
		tablegraph2.NewTableLink(1, table2, nil, nil),
		tablegraph2.NewTableLink(0, table1, nil, nil),
	...
	edge3 := tablegraph2.NewEdge(
		12,
		false,
		tablegraph2.NewTableLink(1, table2, nil, nil),
		tablegraph2.NewTableLink(2, table3, nil, nil),
	)
	edge4 := tablegraph2.NewEdge(
		13,
		false,
		tablegraph2.NewTableLink(2, table3, nil, nil),
		tablegraph2.NewTableLink(1, table2, nil, nil),
	...
	simpleGraph := map[int][]tablegraph2.Edge{
		0: {edge1},
		1: {edge2, edge3},
		2: {edge4},
	}
...
func Test_getCycleGroupId(t *testing.T) {
	edge1 := tablegraph2.NewEdge(
		4,
		false,
		tablegraph2.NewTableLink(2, commonmodels.Table{}, nil, nil),
		tablegraph2.NewTableLink(3, commonmodels.Table{}, nil, nil),
	)
	...
	cycle := []tablegraph2.Edge{edge1, edge2}
